...
<body class="bg-blue-50 flex flex-col items-center justify-center min-h-screen p-4">
  ...
  <div class="text-center mb-10">
    <h1 class="text-4xl font-extrabold text-blue-700">
      Welcome to "Expertise Exchange"
    </h1>
    <p class="text-gray-700 text-lg font-semibold mt-2">
      A Community for Skill Sharing
    </p>
  </div>
  ...
  <div class="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md">
    ...
    <form method="POST" class="space-y-4">
      <input type="email" name="email" placeholder="Email"
             class="w-full px-4 py-2 rounded-xl border border-gray-300" required>

      <input type="password" name="password" placeholder="Password"
             class="w-full px-4 py-2 rounded-xl border border-gray-300" required>

      <button type="submit"
        class="bg-blue-600 text-white w-full py-3 rounded-xl font-bold hover:bg-blue-700 transition">
        Login
      </button>
    </form>
